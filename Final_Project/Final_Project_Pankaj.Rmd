...
## Loading packages
### Note uncomment packages to install
...
Note: Fecal samples andf processing plant samples are excluded from current analysis.
...
#Note the NA values belong to the Fecal samples and Processing plant samples, which are not included in analysis and are filtered out and will not be included in further analysis for this final project.
