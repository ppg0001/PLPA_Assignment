...
#(Descriptive answers written properly in word file that was submissted)
...
## Question9 (Descriptive answers written properly in word file that was submissted)
#Answer:
...
#My GitHub repository link to R code: https://github.com/ppg0001/PLPA_Assignment/blob/main/CodingChallenge2_IntroDataVis.R
